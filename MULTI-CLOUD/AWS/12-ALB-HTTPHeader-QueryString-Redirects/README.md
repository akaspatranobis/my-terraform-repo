...
- **Rule-3:** When Query-String, website=aws-eks redirect to https://Ak-Reggie-DevOps.com/terraform-eks/ 
- **Rule-4:** When Host Header = azure-aks.devopsincloud.com, redirect to https://Ak-Reggie-DevOps/terraform-akas.
...
- Rule-3: When Query-String, website=aws-eks redirect to https://Ak-Reggie-DevOps.com/aws-eks/
```t
  # Rule-3: When Query-String, website=aws-eks redirect to https://Ak-Reggie-DevOps.com/aws-eks/
    { 
      https_listener_index = 0
...
- Rule-4: When Host Header = azure-aks.devopsincloud.com, redirect to https://Ak-Reggie-DevOps.com/azure-aks/azure-kubernetes-service-introduction/
```t
  # Rule-4: When Host Header = azure-aks.devopsincloud.com, redirect to https://Ak-Reggie-DevOps.com/azure-aks/azure-kubernetes-service-introduction/
    { 
      https_listener_index = 0
...
resource "aws_route53_record" "app1_dns" {
  zone_id = data.aws_route53_zone.mydomain.zone_id 
  name    = "terraform-aks.devopsincloud.com"
  type    = "A"
  alias {
    name                   = module.alb.this_lb_dns_name
    zone_id                = module.alb.this_lb_zone_id
...
- When Query-String, website=aws-eks redirect to https://Ak-Reggie-DevOps.com/aws-eks/
```t
# Verify Rule-3
https://myapps.devopsincloud.com/?website=aws-eks 
Observation: 
1. Should Redirect to https://Ak-Reggie-DevOps.com/terraform-eks/
```
