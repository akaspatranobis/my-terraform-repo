# Terraform on AWS with SRE & IaC DevOps | Real-World 19 Demos
...
15. Develop and Reference Terraform Modules locally
16. Develop Terraform Module from scratch
17. Remote State Storage with AWS S3 and DynamoDB
18. Terraform Remote State Datasource
19. IaC DevOps using AWS CodePipeline 
...
## What will students learn in my project?
...
## Are there requirements or prerequisites to use my project?
...
- [HashiCorp Certified: Terraform Associate](https://github.com/akaspatranobis/myterraform-multicloud-portfolio)
