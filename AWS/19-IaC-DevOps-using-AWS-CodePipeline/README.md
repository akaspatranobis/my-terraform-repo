...
- URL: https://github.com/akaspatranobis  (my git repo url)
- Click on **Repositories Tab**
- Click on  **New** to create a new repository 
- **Repository Name:** myterraform-multicloud-portfolio
...
# Execute Git Clone
git clone https://github.com/akaspatranobis/myterraform-multicloud-portfolio
...
3. Destination Folder Path: akaspatranobis/myterraform-multicloud-portfolio/
...
https://github.com/akaspatranobis/myterraform-multicloud-portfolio/
```
